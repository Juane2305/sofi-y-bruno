...
const GoogleCalendarButton = ({
  ...
  return (
    ...
    >
      ...
      <h3 className={`text-lg font-light ${titleClass} px-3`}>
      ...
      <a
        ...
        className={`border-2 py-3 px-6 transform transition-transform duration-300 ease-in-out hover:scale-105 ${buttonClass}`}
      >
