            ...
            <div className="flex flex-col justify-center text-center space-y-7 text-gray-900 w-full max-w-md ">
              ...
              <div className="w-full space-y-4 text-left text-gray-800">
                <p className="text-lg flex justify-between items-center">
                  <span><span className="font-semibold">Nombre:</span> {nombre}</span>
                </p>
              ...
              <button
                className={`py-4 rounded-lg text-white font-bold hover:bg-transparent hover:transition cursor-pointer border-4 transform transition-transform duration-300 ease-in-out hover:scale-105 hover:shadow-lg`} style={claseBotonModal}
